                  ...
                  <form action="{{route('role.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    @method('POST')
                      <div class="form-group">
                        <label for="formGroupExampleInput2">Nama Role</label>
                        <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="" name="nama_role">
                      </div>
                        ...
                        <tbody>
                            @foreach($dataRole as $item)
                              <tr style="text-align: center">
                                <td><a href="{{route('role.edit', $item->id)}}" title="">{{$item->nama_role}}</a></td>
